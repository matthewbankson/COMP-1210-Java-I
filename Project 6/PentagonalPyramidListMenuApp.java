...
*PentagonalPyramidList class and its methods.
*
*Project 6
...
*/
   public static void main(String[] args) throws FileNotFoundException {
      ...
      ArrayList<PentagonalPyramid> thisList = 
         new ArrayList<PentagonalPyramid>();
      PentagonalPyramidList thisPPList = 
         new PentagonalPyramidList(nameOfList, thisList);
